...
export function blockNoteTree(
  ...
  console.debug("🔍 Debug - Raw blocks:", blocks.length);
  console.debug("🔍 Debug - Raw edges:", edges.length);
  ...
  console.debug("🔍 Debug - Children map size:", childrenMap.size);
  console.debug("🔍 Debug - Sibling map size:", siblingsMap.size);
  ...
  console.debug("🔍 Debug - Root blocks count:", rootBlocks.length);
  ...
  console.debug("🔍 Debug - Final root order count:", orderedRootIds.length);
