		...
		<div className="@container flex w-full flex-1 justify-end">
			...
			>
				...
				<div className="pointer-events-none absolute top-1.5 right-1.5 @[180px]:flex hidden items-center gap-0.5">
					<kbd className="flex h-5 select-none items-center gap-1 rounded border bg-background px-1.5 font-medium font-mono text-lg text-muted-foreground">
						⌘
					</kbd>
					<kbd className="flex h-5 select-none items-center gap-1 rounded border bg-background px-1.5 font-medium font-mono text-muted-foreground text-xs">
						K
					</kbd>
				</div>
			</Button>
