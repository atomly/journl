...
- userPrompt must be plain-language editing instructions (not JSON).
...
- Always pass intent as a structured tool argument. Never JSON-encode the whole input inside userPrompt.
